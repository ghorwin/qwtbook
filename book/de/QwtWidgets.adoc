...
Viele dieser Komponenten sind klassischen Anzeigen und Einstellrädern in wissenschaftlich/technischen Geräten nachempfunden.
...
## Drehräder/Einstellräder und Balkenanzeigen
...
Qt selbst bietet für eine Balkenanzeige die Klasse `QProgressBar` an, welche sich aber im Erscheinungsbild an den jeweiligen Plattformstil für Fortschrittsbalken orientiert und auch keine Skalen bietet.
