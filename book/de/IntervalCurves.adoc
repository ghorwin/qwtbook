...
[TIP]
====
Gestapelte Kurven kann man klassisch auch mit gefüllten Linienkurven machen (siehe <<sec:filledCurves>>), welche übereinander gezeichnet werden. Dazu müssen die Linen einen Brush erhalten und von hinten nach vorne gezeichnet werden.
====
...
image::IntervalCurves/StackedCurveByFilledCurves.png[pdfwidth=8cm]


## Berechnung von gestapelten Intervalkurven aus Datenreihen

Häufig hat man die Daten der einzelnen
