...
Gestapelte Kurven entstehen ja durch das _Stapeln_ normaler Datenreihen. Diese müssen nicht zwingend die gleichen X-Werte pro Datenreihe verwenden und können positive und negative Zahlen haben. Um solche Daten korrekt zu stapeln und anzuzeigen ist etwas Vorbereitungsarbeit notwendig.

Beginnen wir mal mit drei einfachen Datenreihen, die direkt dargestellt so aussehen:
...
Welches Verfahren ist jetzt schneller? Hier mal ein Beispiel aus der Praxis: Anfänglich 8760 Stundenwerte, nach dem Hinzufügen von Nulldurchgängen und Vereinheitlichen des Rasters sind es knapp 10000 Datenpunkte.
